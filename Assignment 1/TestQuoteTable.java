public class TestQuoteTable {
	...
	public static void main(String[] args) {
		...
		System.out.println(option[4].amountOfMaterial(510, 300));
		System.out.println((168000) * (6.92/140) + ((168000) * (6.92/140)* 0.12));
